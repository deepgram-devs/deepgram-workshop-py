    ...
    with client.agent.v1.connect() as agent:
        ...
        def on_message(message: AgentMessage) -> None:
            ...
            if message_type == "SettingsApplied":
                ...
                # Uncomment the three lines below. total_latency is
                # end-of-utterance to first audio byte -- the exact number the
                # knobs in TODO 6.1 move, and the only honest way to tell
                # whether a change helped.
                #
                # The report also carries ttt_token_latency, ttt_text_latency,
                # ttt_tool_latency, ttt_thinking_latency, and tts_latency.
                # Every field is optional -- absent, not zero, when it does not
                # apply, which is why the None check below is not decoration.
                # -----------------------------------------------------------
